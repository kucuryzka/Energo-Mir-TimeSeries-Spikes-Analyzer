...
public class AnalysisTimingStatsService
{
    ...
    public async Task<AnalysisDurationEstimateDto> EstimateAsync(
        string database,
        string schema,
        string table,
    ...
    )
    {
        ...
        {
            return new AnalysisDurationEstimateDto
            {
        ...
        return new AnalysisDurationEstimateDto
        {
            ...
            Confidence = stats.SampleCount >= 5 ? EstimateConfidence.high : EstimateConfidence.low,
